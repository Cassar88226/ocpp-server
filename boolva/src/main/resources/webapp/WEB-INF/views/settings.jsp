...
<form:form action="${ctxPath}/manager/settings" modelAttribute="settingsForm">
    ...
    <table class="userInputFullPage">
        ...
        <tr><td><i>
            The time interval in <b>minutes</b> for how often a charging station <br> should request the current time from SteVe.
        </i></td><td></td></tr>
        <tr><td>Expiration:</td><td>
            <form:input path="expiration"/>
        </td></tr>
        <tr><td><i>
            The amount of time in <b>hours</b> for how long a charging station should cache <br> the authorization info of an

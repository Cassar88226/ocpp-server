...
<spring:hasBindErrors name="batchChargePointForm">
    <div class="error" id="batchError">
        Error while trying to add charging station list:
        <ul>
...
<spring:hasBindErrors name="chargePointForm">
    <div class="error" id="singleError">
        Error while trying to add a charging station:
        <ul>
            <c:forEach var="error" items="${errors.allErrors}">
                <li>${error.defaultMessage}</li>
            </c:forEach>
...
<div class="content"><div>
    ...
    <section><span id="batch" style="cursor: pointer">
        Add Charging Station List
        <a class="tooltip" href="#"><img src="${ctxPath}/static/images/info.png" style="vertical-align:middle">
            <span>Insert multiple charging stations at once by entering one ID per line. This operation will leave other fields empty, which can be set later.</span>
        </a>
    </span></section>
    ...
    <section><span>Add Charging Station</span></section>

	...
	<section><span>
		Reservations
			<a class="tooltip" href="#"><img src="${ctxPath}/static/images/info.png" style="vertical-align:middle">
				<span>
				Status definitions:
				WAITING (Waiting for charging station to respond to a reservation request),
				ACCEPTED (Charging station accepted - The only status for active, usable reservations),

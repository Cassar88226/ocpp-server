...
<section><span>
Connection Status for JSON Charging Stations
    	<a class="tooltip" href="#"><img src="${ctxPath}/static/images/info.png" style="vertical-align:middle">
            <span>There can be multiple entries for a charging station.
                This indicates that charging station has opened more than one actual connection.</span>
        </a>
</span></section>
    <table class="res">
        <thead>

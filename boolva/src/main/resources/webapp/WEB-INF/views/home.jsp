...
<div class="tileWrapper">
		<table>
			<tr>
				<td>
					<a class="tileRow1" href="${ctxPath}/manager/chargepoints">Charging Stations :
						<span class="base formatNumber">${stats.numChargeBoxes}</span>
					</a>
					
				</td>				
				<td>
					<a class="tileRow1" href="${ctxPath}/manager/ocppTags">OCPP Tags :
			...
			<tr>
				...
				<td>
						<a class="tileRow1" href="${ctxPath}/manager/users">Users :
							<span class="base formatNumber">${stats.numUsers}</span>
						</a>
				</td>

				<td>
						<a class="tileRow1" href="${ctxPath}/manager/reservations">Active Reservations :
			...
			<tr>
				<td>
					<a class="tileRow1" href="${ctxPath}/manager/transactions">Active Transactions :
			...
			<tr>
				<td>
					<a class="tileRow1" href="${ctxPath}/manager/chargepoints">Received Heartbeats
				...
				<td>
					<a class="tileRow1" href="${ctxPath}/manager/home/ocppJsonStatus">Connected Charging Stations
						<span class="baseTable">
							<span class="baseRow">
			...
			<tr>
				...
				<td>
					<a class="tileRow1" href="${ctxPath}/manager/home/connectorStatus">Connector Status
						<span class="baseTable">

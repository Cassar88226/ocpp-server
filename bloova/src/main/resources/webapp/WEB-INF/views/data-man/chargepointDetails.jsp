...
<spring:hasBindErrors name="chargePointForm">
    <div class="error">
        Error while trying to update a charging station:
        <ul>
...
<div class="content"><div>
    <section><span>
        ...
        <a class="tooltip" href="#"><img src="${ctxPath}/static/images/info.png" style="vertical-align:middle">
            <span>Read-only fields are updated by the charging station.</span>
        </a>
    </span></section>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="tooltip" href="#"><img src="${ctxPath}/static/images/info.png" style="vertical-align:middle">
                                <span>This field is set when adding a charging station, and cannot be changed later</span>
                            </a>
                        </td>
                    </tr>
                    <tr><td>Endpoint Address:</td><td>${cp.chargeBox.endpointAddress}</td></tr>
                    <tr><td>Ocpp Protocol:</td><td>${cp.chargeBox.ocppProtocol}</td></tr>
                    <tr><td>Charging Station Vendor:</td><td>${cp.chargeBox.chargePointVendor}</td></tr>
                    <tr><td>Charging Station Model:</td><td>${cp.chargeBox.chargePointModel}</td></tr>
                    <tr><td>Charging Station Serial Number:</td><td>${cp.chargeBox.chargePointSerialNumber}</td></tr>

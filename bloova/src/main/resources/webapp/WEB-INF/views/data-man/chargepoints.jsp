...
<div class="content">
    ...
    Unknown Charging Stations
    <a class="tooltip" href="#"><img src="${ctxPath}/static/images/info.png" style="vertical-align:middle">
        <span>A list of charging stations that attempted to connect and send a boot notification but were not present in database.</span>
    </a>
    </span></section>
                ...
                <tr>
                    ...
                    <td>
                        <form:form cssClass="inline" action="${ctxPath}/manager/chargepoints/unknown/add/${item.key}/" method="post">
                            <input type="submit" class="blueSubmit" value="Create"/>
                        </form:form>
                        &nbsp;
    ...
    <a class="tooltip" href="#"><img src="${ctxPath}/static/images/info.png" style="vertical-align:middle">
        <span>Deleting a charging station causes losing all related information including transactions, reservations, connector status and connector meter values.</span>
    </a>
    </span></section>
    <div id="overview">
            ...
            <tr>
                ...
                <th>
                    <form:form action="${ctxPath}/manager/chargepoints/add" method="get">
                        <input type="submit" class="blueSubmit" value="Create New">
                    </form:form>
                </th>
            </tr>
            </thead>
